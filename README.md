...
The current license text (LICENSE.txt) is directly copied from the LTR QGIS-OSGeo4W-3.34.4-1 installer UI. In case QGIS or the dependencies are updated, update this text as well.
