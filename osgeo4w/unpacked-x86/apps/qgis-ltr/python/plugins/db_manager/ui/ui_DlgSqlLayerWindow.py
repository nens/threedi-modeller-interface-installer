...
"columns", None))
        ...
        self.btnExecute.setToolTip(_translate("DbManagerDlgSqlLayerWindow", "Execute query (Ctrl+R)", None))
        self.btnExecute.setText(_translate("DbManagerDlgSqlLayerWindow", "Execute", None))
        self.btnExecute.setShortcut(_translate("DbManagerDlgSqlLayerWindow", "Ctrl+R", None))
