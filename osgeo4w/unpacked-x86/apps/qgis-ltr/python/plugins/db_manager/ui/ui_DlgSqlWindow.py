...
"unique values", None))
        ...
        self.btnExecute.setToolTip(_translate("DbManagerDlgSqlWindow", "Execute query (Ctrl+R)", None))
        self.btnExecute.setText(_translate("DbManagerDlgSqlWindow", "Execute", None))
        self.btnExecute.setShortcut(_translate("DbManagerDlgSqlWindow", "Ctrl+R", None))
