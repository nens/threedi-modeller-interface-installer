...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '@osgeo4w@\\apps\\Python27',
    'default_mod_dir':    '@osgeo4w@\\apps\\Python27\\Lib\\site-packages',
    'default_sip_dir':    '@osgeo4w@\\apps\\Python27\\sip',
    'deployment_target':  '',
    'platform':           'win32-msvc2008',
    'py_conf_inc_dir':    '@osgeo4w@\\apps\\Python27\\include',
    'py_inc_dir':         '@osgeo4w@\\apps\\Python27\\include',
    'py_lib_dir':         '@osgeo4w@\\apps\\Python27\\libs',
    'py_version':         0x020704,
    'qt_framework':       0,
    'sip_bin':            '@osgeo4w@\\bin\\sip',
    'sip_config_args':    '--destdir @osgeo4w@/apps/Python27/lib/site-packages --bindir @osgeo4w@/bin --incdir @osgeo4w@/include',
    'sip_inc_dir':        '@osgeo4w@\\include',
    'sip_mod_dir':        '@osgeo4w@\\apps\\Python27\\lib\\site-packages',
