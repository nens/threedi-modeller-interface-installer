...
#define PG_VERSION_STR "PostgreSQL 9.2.4, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 64-bit"
...
#define VAL_CONFIGURE "--enable-thread-safety --enable-integer-datetimes --with-ldap"
