...
_libs["grass_vedit.7.4.1"] = load_library("grass_vedit.7.4.1")
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 45
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 50
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 58
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 5
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_split_lines'):
    Vedit_split_lines = _libs['grass_vedit.7.4.1'].Vedit_split_lines
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 7
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_connect_lines'):
    Vedit_connect_lines = _libs['grass_vedit.7.4.1'].Vedit_connect_lines
    Vedit_connect_lines.restype = c_int
    Vedit_connect_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist), c_double]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 10
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_extend_lines'):
    Vedit_extend_lines = _libs['grass_vedit.7.4.1'].Vedit_extend_lines
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 13
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_modify_cats'):
    Vedit_modify_cats = _libs['grass_vedit.7.4.1'].Vedit_modify_cats
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 17
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_copy_lines'):
    Vedit_copy_lines = _libs['grass_vedit.7.4.1'].Vedit_copy_lines
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 20
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_chtype_lines'):
    Vedit_chtype_lines = _libs['grass_vedit.7.4.1'].Vedit_chtype_lines
    Vedit_chtype_lines.restype = c_int
    Vedit_chtype_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 23
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_delete_lines'):
    Vedit_delete_lines = _libs['grass_vedit.7.4.1'].Vedit_delete_lines
    Vedit_delete_lines.restype = c_int
    Vedit_delete_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 24
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_delete_area_centroid'):
    Vedit_delete_area_centroid = _libs['grass_vedit.7.4.1'].Vedit_delete_area_centroid
    Vedit_delete_area_centroid.restype = c_int
    Vedit_delete_area_centroid.argtypes = [POINTER(struct_Map_info), c_int]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 25
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_delete_area'):
    Vedit_delete_area = _libs['grass_vedit.7.4.1'].Vedit_delete_area
    Vedit_delete_area.restype = c_int
    Vedit_delete_area.argtypes = [POINTER(struct_Map_info), c_int]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 26
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_delete_areas_cat'):
    Vedit_delete_areas_cat = _libs['grass_vedit.7.4.1'].Vedit_delete_areas_cat
    Vedit_delete_areas_cat.restype = c_int
    Vedit_delete_areas_cat.argtypes = [POINTER(struct_Map_info), c_int, c_int]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 29
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_get_min_distance'):
    Vedit_get_min_distance = _libs['grass_vedit.7.4.1'].Vedit_get_min_distance
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 33
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_flip_lines'):
    Vedit_flip_lines = _libs['grass_vedit.7.4.1'].Vedit_flip_lines
    Vedit_flip_lines.restype = c_int
    Vedit_flip_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 36
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_merge_lines'):
    Vedit_merge_lines = _libs['grass_vedit.7.4.1'].Vedit_merge_lines
    Vedit_merge_lines.restype = c_int
    Vedit_merge_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 39
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_move_lines'):
    Vedit_move_lines = _libs['grass_vedit.7.4.1'].Vedit_move_lines
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 43
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_render_map'):
    Vedit_render_map = _libs['grass_vedit.7.4.1'].Vedit_render_map
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 47
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_select_by_query'):
    Vedit_select_by_query = _libs['grass_vedit.7.4.1'].Vedit_select_by_query
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 51
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_snap_point'):
    Vedit_snap_point = _libs['grass_vedit.7.4.1'].Vedit_snap_point
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 53
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_snap_line'):
    Vedit_snap_line = _libs['grass_vedit.7.4.1'].Vedit_snap_line
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 55
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_snap_lines'):
    Vedit_snap_lines = _libs['grass_vedit.7.4.1'].Vedit_snap_lines
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 59
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_move_vertex'):
    Vedit_move_vertex = _libs['grass_vedit.7.4.1'].Vedit_move_vertex
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 63
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_add_vertex'):
    Vedit_add_vertex = _libs['grass_vedit.7.4.1'].Vedit_add_vertex
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 65
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_remove_vertex'):
    Vedit_remove_vertex = _libs['grass_vedit.7.4.1'].Vedit_remove_vertex
...
# C:/msys64/usr/src/grass741/dist.x86_64-w64-mingw32/include/grass/defs/vedit.h: 69
if hasattr(_libs['grass_vedit.7.4.1'], 'Vedit_bulk_labeling'):
    Vedit_bulk_labeling = _libs['grass_vedit.7.4.1'].Vedit_bulk_labeling
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 7
try:
    NO_SNAP = 0
except:
    pass
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 8
try:
    QUERY_UNKNOWN = (-1)
except:
    pass
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 10
try:
    TYPE_POINT = 1
except:
    pass
...
# C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 11
try:
    DRAW_POINT = 1
except:
    pass
...
rpoint = struct_rpoint # C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 45

robject = struct_robject # C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 50

robject_list = struct_robject_list # C:\\msys64\\usr\\src\\grass741\\dist.x86_64-w64-mingw32\\include\\grass\\vedit.h: 58
