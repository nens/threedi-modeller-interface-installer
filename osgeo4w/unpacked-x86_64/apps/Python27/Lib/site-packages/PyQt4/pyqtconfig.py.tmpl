...
_pkg_config = {
    'pyqt_bin_dir':      '@osgeo4w@\\bin',
    'pyqt_config_args':  '--verbose --confirm-license --destdir @osgeo4w@/apps/Python27/lib/site-packages --sipdir @osgeo4w@/apps/Python27/sip --plugin-destdir @osgeo4w@\\apps\\Qt4\\plugins\\designer --bindir @osgeo4w@/bin',
    'pyqt_mod_dir':      '@osgeo4w@\\apps\\Python27\\lib\\site-packages\\PyQt4',
    ...
    'pyqt_sip_dir':      '@osgeo4w@\\apps\\Python27\\sip',
    ...
    'qt_archdata_dir':   '@osgeo4w@/apps/qt4',
    'qt_data_dir':       '@osgeo4w@/apps/qt4',
    'qt_dir':            '@osgeo4w@\\apps\\qt4',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '@osgeo4w@\\include\\qt4',
    'qt_lib_dir':        '@osgeo4w@\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040805,
    'qt_winconfig':      'shared'
}
